(function () {
    ...
    function generateRandomSample(context, w, h) {
        ...
        for (var o = 0; o < h; o++) {
            var value = interpolate((o / factor), Math.floor(o / factor), intensityCurve[Math.floor(o / factor)], Math.floor(o / factor) + 1, intensityCurve[Math.floor(o / factor) + 1]);
        ...
        for (var p = 0; p < (w * h); p++) {
            ...
            color += intensity[Math.floor(p / w)];
